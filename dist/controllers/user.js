...
const verifyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const matched = yield (verificationToken === null || verificationToken === void 0 ? void 0 : verificationToken.compareToken(token));
    if (!matched)
        return res.status(403).json({ error: "Invalid token." });
...
const generateForgetPasswordLink = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, mail_1.sendVerificationPasswordLink)({ email: user.email, link: resetLink });
