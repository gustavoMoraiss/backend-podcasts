...
const isValidPassResetToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const matched = yield (resetToken === null || resetToken === void 0 ? void 0 : resetToken.compareToken(token));
    if (!matched)
        return res.status(403).json({
            error: "Unauthorized access, invalid token."
        });
...
const mustAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = authorization === null || authorization === void 0 ? void 0 : authorization.split("Beare ")[1];
    if (!token)
        return res.status(403).json({
